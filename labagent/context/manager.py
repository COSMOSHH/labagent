...
from labagent.serialization import build_messages
...
SESSION_SUBDIR = ".labagent/session/tool-results"
...
async def auto_compact(
    ...
    for attempt in range(max_retries):
        try:
            from labagent.tools.base import StreamEnd, StreamEvent, TextDelta
