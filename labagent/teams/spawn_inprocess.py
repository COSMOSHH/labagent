...
from labagent.teams.progress import TeammateProgress, random_verb

if TYPE_CHECKING:
    from labagent.agent import Agent
    from labagent.conversation import ConversationManager
    from labagent.teams.models import TeammateInfo
    ...
    async def _run() -> str:
        ...
        try:
            if conversation is not None:
                ...
                from labagent.conversation import ConversationManager as CM
                conv = CM()
