...
from labagent.teams.backend_detect import BackendDetectionError, detect_backend
from labagent.teams.mailbox import Mailbox, create_message
...
from labagent.teams.progress import TeammateProgress
from labagent.teams.registry import AgentNameRegistry
from labagent.teams.shared_task import SharedTaskStore
from labagent.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from labagent.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
