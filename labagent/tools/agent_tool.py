...
if TYPE_CHECKING:
    from labagent.agent import Agent
    ...
    from labagent.client import LLMClient
...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from labagent.agents.fork import ForkError, build_forked_messages
        from labagent.agents.parser import AgentDef
        from labagent.agents.tool_filter import resolve_agent_tools
        from labagent.agent import Agent as AgentClass
        ...
        if p.subagent_type is None:
            from labagent.context import clone_replacement_state
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from labagent.agents.fork import ForkError, build_forked_messages
        from labagent.agents.parser import AgentDef
        from labagent.agents.tool_filter import build_teammate_tools
        from labagent.agent import Agent as AgentClass
        from labagent.conversation import ConversationManager
        from labagent.permissions import (
            DangerousCommandDetector,
        ...
        from labagent.teams.models import BackendType, TeammateInfo
    ...
    def _spawn_pane_teammate(
        ...
        try:
            if backend == BackendType.TMUX:
                from labagent.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from labagent.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from labagent.worktree.integration import (
    ...
    def _create_client_for_model(self, model_alias: str) -> LLMClient | None:
        ...
        from labagent.client import create_client
        from labagent.config import ProviderConfig
