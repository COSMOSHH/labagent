...
from labagent.skills.parser import SkillDef, substitute_arguments

if TYPE_CHECKING:
    from labagent.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from labagent.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
