...
def build_teammate_tools(
    ...
    from labagent.tools.send_message import SendMessageTool
    from labagent.tools.task_create import TaskCreateTool
    from labagent.tools.task_get import TaskGetTool
    from labagent.tools.task_list import TaskListTool
    from labagent.tools.task_update import TaskUpdateTool
