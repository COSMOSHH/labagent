...
PROJECT_AGENTS_DIR = ".labagent/agents"
USER_AGENTS_DIR = "~/.labagent/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("labagent.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from labagent.agents.parser import parse_frontmatter, _validate_agent_meta
